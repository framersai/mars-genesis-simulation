...
import type { ScenarioPackage, WorldState, AgentFieldDefinition, MetricDefinition, EffectDefinition, EventDefinition, ScenarioPolicies, ScenarioUiDefinition, DepartmentDefinition, ScenarioHooks, ScenarioPreset, KnowledgeBundle } from '../../src/engine/types.js';
